...
def main(cfg: DictConfig):
    ...
    # ================simcse - cos_sim======================
        ...
        # saved_state = load_states_from_checkpoint('/anaconda3/envs/paper/DPR/donwloaded_data/downloads/checkpoint/retriever/single-adv-hn/nq/bert-base-encoder.cp')
               
        # using SimCSE-based dual-encoder
        saved_state = load_states_from_checkpoint("/anaconda3/envs/paper/DPR/output/simcse_ckpt/dpr_biencoder.32")
        ...
        # hate speech queries example
        total_queries = ['a direct attack against people — rather than concepts or institutions— based on protected characteristics: race, ethnicity, national origin, disability, religious affiliation, caste, sexual orientation, sex, gender identity, and severe disease. ',
        ...
        # ctx_files_patterns = ['/anaconda3/envs/paper/DPR/donwloaded_data/downloads/data/retriever_results/nq/single-adv-hn/wikipedia_passages_*']

        # SimCSE-based embedding
        ctx_files_patterns = ["/anaconda3/envs/paper/DPR/output/DenseEmbedding/SimCSE_embedding_0"]
